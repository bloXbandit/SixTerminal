...
class ScheduleCopilot:
    ...
    def query(self, user_input: str, chat_history: List[Dict] = [], current_view: str | None = None) -> str:
        """
        ...
        ai_mode = (config.get("ai_mode") or "cloud").strip().lower()
        project_alias = config.get("project_alias") or "Stelic Project"
...
CURRENT VIEW: {current_view or 'Unknown'}
